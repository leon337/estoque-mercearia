    ...
    <main className="mx-auto min-h-screen max-w-2xl px-4 py-8 sm:px-6">
      ...
      <form action={createProduct} className="mt-6 grid gap-4 rounded-lg border p-5">
        <label className="grid gap-1 text-sm font-medium">
          Código interno *
          <input className="rounded-md border px-3 py-2" name="internal_code" required />
        </label>
        <label className="grid gap-1 text-sm font-medium">
          Código de barras
          <input className="rounded-md border px-3 py-2" inputMode="numeric" name="barcode" />
        </label>
        <label className="grid gap-1 text-sm font-medium">
          Nome *
        ...
        <label className="grid gap-1 text-sm font-medium">
          Categoria
          <select className="rounded-md border px-3 py-2" defaultValue="" name="category_id">
        ...
        <label className="grid gap-1 text-sm font-medium">
          Unidade *
          <input className="rounded-md border px-3 py-2" name="unit" placeholder="UN, KG, L, CX..." required />
        </label>
        <label className="grid gap-1 text-sm font-medium">
          Estoque mínimo *
          <input className="rounded-md border px-3 py-2" defaultValue="0" min="0" name="minimum_stock" required step="0.001" type="number" />
        </label>
        <div className="mt-2 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
          <Link className="rounded-md border px-4 py-3 text-center font-semibold" href="/products">Cancelar</Link>
          <button className="rounded-md bg-black px-4 py-3 font-semibold text-white" type="submit">Cadastrar produto</button>
        </div>
      </form>
    </main>
  );
