...
export const SEED_ROUTES = Object.freeze([
  ...
  { template: "/purchases", path: "/purchases", name: "purchases", type: "authenticated" },
  { template: "/purchases/new", path: "/purchases/new", name: "purchase-new", type: "administrative" },
  { template: "/purchases/[id]", path: null, name: "purchase-detail", type: "administrative", dynamic: true },
